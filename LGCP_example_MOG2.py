...
kernel = [autogp.kernels.Matern_3_2(1, lengthscale=lengthscale_initial, std_dev = std_dev_initial)]
...
np.savetxt("../../Workspace/updated_AutoGP/R_plots/data_inputs2.csv", inputs, header='inputs',  delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/data_outputs2.csv", outputs,  header='outputs', delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/xtest2.csv", xtest,  header='xtest', delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/ytest2.csv", ytest,  header='ytest', delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/xtrain2.csv", xtrain,  header='xtrain', delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/ytrain2.csv", ytrain,  header='ytrain', delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/sample_intensity_test2.csv", sample_intensity[idx[N:]],  header='sample_intensity_test', delimiter=",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/total_results_ypred2.csv", ypred_np, header='ypred', delimiter =",")
np.savetxt("../../Workspace/updated_AutoGP/R_plots/total_results_postvar2.csv", post_var_np, header='post_var', delimiter =",")
